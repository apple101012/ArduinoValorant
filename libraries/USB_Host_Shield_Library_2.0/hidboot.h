...
struct MOUSEINFO {
    struct {
        ...
        uint8_t bmXButton1 : 1;  // Front button (xbutton 2)
        uint8_t bmXButton2 : 1;  // Back button (xbutton 1)
        uint8_t bmDummy : 3;     // Reserved bits
    };
    int16_t dX; // Change to int16_t to handle large movements
    int16_t dY;
    int8_t dZ;
};
